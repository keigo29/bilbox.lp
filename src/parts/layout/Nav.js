export default function Nav() {
    return (
      ...
      <nav class="hidden gap-12 lg:flex">
        <a href="#" class="text-lg font-semibold text-gray-600 transition duration-100 hover:text-green-500 active:text-indigo-700">特徴</a>
        <a href="#" class="text-lg font-semibold text-gray-600 transition duration-100 hover:text-green-500 active:text-indigo-700">料金プラン</a>
        <a href="#" class="text-lg font-semibold text-gray-600 transition duration-100 hover:text-green-500 active:text-indigo-700">Pricing</a>
        <a href="#" class="text-lg font-semibold text-gray-600 transition duration-100 hover:text-green-500 active:text-indigo-700">About</a>
      </nav>
      {/* <!-- nav - end --> */}
      ...
      <a href="#" class="hidden rounded-xl bg-green-500 px-8 py-3 text-center text-sm font-semibold text-gray-100 outline-none ring-indigo-300 transition duration-100 hover:bg-green-600 focus-visible:ring active:text-gray-700 md:text-base lg:inline-block">
        新規登録
        </a>
      </div>
